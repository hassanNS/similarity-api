...
const columnsDraft: GridColDef[] = [
  {
    ...
    renderHeader(params) {
      return (
        <strong className="">{params.colDef.headerName} 🔑</strong>
      )
    },
  },
...
// some advanced typescript
// this generic of "K" takes all the properities of ApiRequest table and then we make some changes
